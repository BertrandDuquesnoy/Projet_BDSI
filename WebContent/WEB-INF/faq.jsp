...
<p>A partir de votre page d'accueil, cochez la case "Stages" située en bas de l'écran, l'ensemble des stages effectués à l'étranger s'afficheront alors sur la google Map, cliquez sur les marqueurs pour obtenir des informations sur un stage en particulier.
</p>
<p>
