...
function supprimerArticle(id){
	...
	<c:forEach var="i" begin="0" end="0">
		<div style="float:left">
			<div id="options_admin">
				<p>
					<span class="options_admin" onclick="supprimerArticle(7)">Supprimer l'article</span>  
			...
			<div id="corps">
				<p class="titre_section">Mon stage chez Dassault Aviation</p>
				<p>
				...
				<form>
					<p class="commentaire">Mon premier commentaire erztgnzrt gezt h zrh etjzrtg zsth ztr hzstrh ztz rth trh ze-y ze hz ryy trh etyh srtjh d strhjstyhstyjhs rthsrhstrj trhsthtrh styh sthdt yhjstrhstrhs ththsrthsrth srthsytjhstrh strh st hsrth trhstrhst sth</p>
					<p class="commentaire">Un deuxième !</p>
	...
	<div style="float:left">
		...
		<div id="corps">
			<p class="titre_section">Mon (2eme) stage chez Dassault Aviation</p>
			<p>
				<span class="nb_etudiants_partis">Ma première impression : </span>
			</p>
			<p>
